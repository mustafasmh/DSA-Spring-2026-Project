...
add_song(playlist, "I Thought It Was You", "Herbie Hancock", to_seconds(3, 51), "Funk", "https://youtu.be/IlKFeaeS1vc?si=pUU9IedOsW8jKIhE")
add_song(playlist, "Sunlight", "Herbie Hancock", to_seconds(7, 10), "Funk", "https://youtu.be/v2WQKixX6Yc?si=RMqvpOpRN3N3yfVX")
add_song(playlist, "Voodoo Charm", "Kingfish Ingram", to_seconds(3, 47), "Blues", "https://youtu.be/23Nbp1v3g_g?si=Yp6towkCYjMuhZGz")
add_song(playlist, "Blank Fairy", "Akira Yamaoka", to_seconds(1, 12), "Industrial", "https://youtu.be/EydQOWhM0SY?si=TA0VHvRY18c15c7N")
add_song(playlist, "Theme Of Laura (Repetition)", "Akira Yamaoka", to_seconds(1, 50), "Ambient", "https://youtu.be/OhGRAsr9Ifw?si=M3Gs6t0ZbMcy7jyt")
add_song(playlist, "How Insensitive", "Emily Remler", to_seconds(9, 56), "Jazz", "https://youtu.be/AuBKGQXopIQ?si=AlkdXIQYLPfwpguf")
add_song(playlist, "In A Sentimental Mood", "Emily Remler", to_seconds(7, 49), "Jazz", "https://youtu.be/OswTjWRPU5M?si=eFZ_RKaCLPFuzgPk")
add_song(playlist, "Leaving Hope", "Nine Inch Nails", to_seconds(5, 57), "Ambient", "https://youtu.be/R-aEUmz32f4?si=WYqicu82yYdD3FrE")
add_song(playlist, "This Isn't The Place", "Nine Inch Nails", to_seconds(4, 51), "Ambient", "https://youtu.be/_g8nAqDu3gI?si=FUJhYhagcy7Mo2-V")
add_song(playlist, "The Fragile", "Nine Inch Nails", to_seconds(4, 51), "Industrial", "https://youtu.be/BO-iKVlPz8I?si=kt5yNN-cZLP3FxJr")
add_song(playlist, "Rust", "Yussef Dayes", to_seconds(3, 59), "Jazz", "https://youtu.be/YASaUI9bhQY?si=D443h3h4u-HWa3do")
add_song(playlist, "Dreams", "Fleetwood Mac", to_seconds(4, 17), "Pop", "https://youtu.be/5oWyMakvQew?si=k63l6cf72QOGbyaM")
add_song(playlist, "Me and Your Mama", "Childish Gambino", to_seconds(6, 19), "R&B", "https://youtu.be/ZiIjLL9wq4Q?si=oJZ1d0Cx48Nz39OX")
add_song(playlist, "Redbone", "Childish Gambino", to_seconds(5, 26), "R&B", "https://youtu.be/k49I5m1J6Is?si=rbWu_lK3YFuzJJyd")
add_song(playlist, "Doomsday", "MF DOOM", to_seconds(4, 58), "Rap", "https://youtu.be/LMeluRz2wv4?si=_PbcWAeHfGroyCeZ")
add_song(playlist, "One Beer", "MF DOOM", to_seconds(2, 21), "Rap", "https://youtu.be/h69FSgua80A?si=MW15ZqaqXsUxQd5l")
add_song(playlist, "Resident Evil 2: Save Room", "Capcom", to_seconds(2, 21), "Ambient", "https://youtu.be/53aDI5K49F4?si=jS6fe7aglq9y3Mv_")
add_song(playlist, "Elaine", "ABBA", to_seconds(3, 44), "Pop", "https://youtu.be/YAGZ8at4Joc?si=3K5dfVFjgWWVD73F")
add_song(playlist, "Wild Blue", "John Mayer", to_seconds(4, 5), "Pop", "https://youtu.be/EUwynJ-WHGo?si=iWExPIQxYh1oNYAF")
add_song(playlist, "Reanimator", "Joji", to_seconds(3, 3), "R&B", "https://youtu.be/7xEmPzCTVck?si=0RuN2WC0MKdjfZe1")
add_song(playlist, "The Day She Left", "Aamir Zaki", to_seconds(5, 4), "Rock", "https://youtu.be/xF-YeZEGUs8?si=eV0EN2c1un52cJ9p")
add_song(playlist, "Yeh Jo Halka Halka", "Nusrat Fateh Ali Khan", to_seconds(29, 49), "Qawwali", "https://youtu.be/EPPeR5mjpo8?si=KJ-fdwiKeg4yEGff")
add_song(playlist, "Tumhain Dillagi Bhool Jani Paray Gi", "Nusrat Fateh Ali Khan", to_seconds(16, 22), "Qawwali", "https://youtu.be/X0aWquXGXXU?si=HKE2cNVJHgBkSp0X")
